...
Great! Now we have two datasets to work with: one made-up one about pirate ships, and one real-life dataset from your friends. Now, let's see if we can use my code about the pirate ships to learn to write your own code about your data.
